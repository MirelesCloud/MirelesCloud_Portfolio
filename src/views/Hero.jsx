...
const Hero = ({ children, offset }) => (
  <>
    <Divider clipPath="polygon(0 16%, 100% 4%, 100% 82%, 0 94%)" speed={0.2} offset={offset}>
      ...
      <UpDownWide>
        <SVG icon="star" hiddenMobile width={16} fill={colors['green-dark']} left="80%" top="10%" />
        <SVG icon="star" width={12} fill={colors.white} left="90%" top="50%" />
        <SVG icon="ellipse" width={60} stroke={colors['grey-darkest']} left="30%" top="50%"/>
        <SaturnRise>
          <SVG icon="sunShape" width={60} fill={colors.red} left="75%" top="60%"/>
        </SaturnRise>
      ...
      <SVG icon="circle" width={48} stroke={colors['orange-darker']} left="5%" top="70%" />
